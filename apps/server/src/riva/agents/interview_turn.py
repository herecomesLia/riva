...
class InterviewTurnAgent(Agent[InterviewTurnInput, InterviewTurnOutput]):
    ...
    system_prompt = """You assess one answer turn in a formal mock interview and decide whether to ask one dynamic follow-up or complete the current main question.
