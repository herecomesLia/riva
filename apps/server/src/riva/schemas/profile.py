...
class CurrentDatedInput(StrictAPIModel):
    id: StandardUUID
    start_date: Month
    end_date: Month | None
    is_current: bool
...
class CareerProfileProjectExperienceInput(StrictAPIModel):
    id: StandardUUID
    name: RequiredText
    role: OptionalText
    start_date: Month
...
class CareerProfileSkillInput(StrictAPIModel):
    id: StandardUUID
    name: RequiredText
...
class CareerProfileResponse(StrictAPIModel):
...
class CareerProfileGetResponse(StrictAPIModel):
    profile: CareerProfileResponse | None


class CareerProfilePutResponse(StrictAPIModel):
