...
from riva.services.types import MAX_RAW_JOB_DESCRIPTION_LENGTH, DomainModel
...
class RoleDomainModel(DomainModel):
...
class TargetRoleExperienceRange(RoleDomainModel):
...
class MissingJobDescriptionResponse(RoleDomainModel):
    status: Literal["missing"]
    raw_text: None
    version: None


class SavedJobDescriptionResponse(RoleDomainModel):
    status: Literal["saved"]
    raw_text: RawJobDescription
    version: TargetRoleVersion


class ReadyJobDescriptionResponse(RoleDomainModel):
...
class QualificationRequirements(RoleDomainModel):
...
class RequiredSkillGroups(RoleDomainModel):
...
class JobDescriptionAnalysisResponse(RoleDomainModel):
...
class MatchingAnalysisVersionContext(RoleDomainModel):
...
class MissingProfileContext(RoleDomainModel):
    exists: Literal[False]
    version: None
    completed: Literal[False]


class ExistingProfileContext(RoleDomainModel):
    exists: Literal[True]
    version: TargetRoleVersion
    completed: bool
...
class TargetRoleResponse(RoleDomainModel):
    id: UUID
    title: RequiredText
...
class RolesPageResponse(RoleDomainModel):
...
class TargetRoleDetailsRequest(RoleDomainModel):
    title: RequiredText
    company: OptionalText
    recruitment_type: TargetRoleRecruitmentType | None
    location: OptionalText
...
class SetCurrentTargetRoleRequest(RoleDomainModel):
    version: TargetRoleVersion


class UpdatePreparationStatusRequest(RoleDomainModel):
    version: TargetRoleVersion
    preparation_status: ActiveTargetRolePreparationStatus


class ArchiveTargetRoleRequest(RoleDomainModel):
    version: TargetRoleVersion


class SaveJobDescriptionRequest(RoleDomainModel):
    version: TargetRoleVersion
    raw_text: RawJobDescription


class StartJobDescriptionParsingRequest(RoleDomainModel):
    version: TargetRoleVersion
    job_description_version: TargetRoleVersion


class StartMatchingAnalysisRequest(RoleDomainModel):
    version: TargetRoleVersion


class UpdateJobDescriptionAnalysisListModuleRequest(RoleDomainModel):
    version: TargetRoleVersion
    job_description_version: TargetRoleVersion
    analysis_version: TargetRoleVersion
    field: Literal[
...
class UpdateJobDescriptionAnalysisQualificationRequirementsRequest(RoleDomainModel):
    version: TargetRoleVersion
    job_description_version: TargetRoleVersion
    analysis_version: TargetRoleVersion
...
class UpdateJobDescriptionAnalysisRequiredSkillsRequest(RoleDomainModel):
    version: TargetRoleVersion
    job_description_version: TargetRoleVersion
    analysis_version: TargetRoleVersion
