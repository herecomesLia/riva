...
class PracticeSessionSelection(DomainModel):
...
class PracticeQuestionSourceAvailability(DomainModel):
    model_config = ConfigDict(extra="forbid")
...
class PracticeSetupCapabilitiesResponse(DomainModel):
    model_config = ConfigDict(extra="forbid")
...
class PracticeSetupAvailableResponse(DomainModel):
    status: Literal["available"]


class PracticeSetupBlockedResponse(DomainModel):
...
class ContinuePracticeQuestionRequest(DomainModel):
    model_config = ConfigDict(extra="forbid")
...
class RetryPracticeQuestionRequest(DomainModel):
    model_config = ConfigDict(extra="forbid")
...
class SkipPracticeQuestionRequest(DomainModel):
    model_config = ConfigDict(extra="forbid")
...
class SetPracticeQuestionSavedRequest(DomainModel):
    model_config = ConfigDict(extra="forbid")
...
class SetPracticeQuestionWeakRequest(DomainModel):
    model_config = ConfigDict(extra="forbid")
...
class PracticeQuestionReferenceAnswerRequest(DomainModel):
    model_config = ConfigDict(extra="forbid")
...
class PracticeFollowUpReferenceAnswerRequest(DomainModel):
    model_config = ConfigDict(extra="forbid")
...
class SubmitPrimaryAnswerRequest(DomainModel):
    model_config = ConfigDict(extra="forbid")
...
class SubmitFollowUpAnswerRequest(DomainModel):
    model_config = ConfigDict(extra="forbid")
...
class EndPracticeFollowUpsRequest(DomainModel):
    model_config = ConfigDict(extra="forbid")
...
class CompletePracticeSessionRequest(DomainModel):
    model_config = ConfigDict(extra="forbid")

    version: Annotated[int, Field(ge=1)]


class EndPracticeSessionEarlyRequest(DomainModel):
    model_config = ConfigDict(extra="forbid")
...
class RevealPracticeQuestionGuidanceRequest(DomainModel):
    model_config = ConfigDict(extra="forbid")
...
class RevealPracticeFollowUpGuidanceRequest(DomainModel):
    model_config = ConfigDict(extra="forbid")
...
class PracticeDomainModel(DomainModel):
    model_config = ConfigDict(extra="forbid")
...
class PracticeGuidanceNotRequestedResponse(PracticeDomainModel):
    status: Literal["notRequested"]
    content: None = None


class PracticeGuidanceRevealedResponse(PracticeDomainModel):
...
class PracticeGuidanceUnavailableResponse(PracticeDomainModel):
...
class PracticeReferenceAnswerNotRequestedResponse(PracticeDomainModel):
    status: Literal["notRequested"]
    content: None = None
    viewed_before_submission: Literal[False] = False


class PracticeReferenceAnswerUnavailableResponse(PracticeDomainModel):
    status: Literal["unavailable"]
    content: None = None
    viewed_before_submission: Literal[False] = False


class PracticeMainReferenceAnswerContentResponse(PracticeDomainModel):
    kind: Literal[
...
class PracticeFollowUpReferenceAnswerContentResponse(PracticeDomainModel):
    kind: Literal[
...
class PracticeMainReferenceAnswerRevealedResponse(PracticeDomainModel):
    status: Literal["revealed"]
    content: PracticeMainReferenceAnswerContentResponse
    viewed_before_submission: bool


class PracticeFollowUpReferenceAnswerRevealedResponse(PracticeDomainModel):
    status: Literal["revealed"]
...
class PracticeQuestionResponse(PracticeDomainModel):
    id: StandardUUID
...
class PracticeAnswerResponse(PracticeDomainModel):
    id: StandardUUID
    content: PracticeAnswerContent
    created_at: datetime
...
class PracticeFollowUpQuestionResponse(PracticeDomainModel):
    id: StandardUUID
    prompt: QuestionCardPrompt
    created_at: datetime
    order: Annotated[
...
class PracticeActiveSessionBase(PracticeDomainModel):
...
class PracticeAwaitingFollowUpExchangeResponse(PracticeDomainModel):
    status: Literal["awaitingAnswer"]
    question: PracticeFollowUpQuestionResponse
    answer: None = None


class PracticeAnsweredFollowUpExchangeResponse(PracticeDomainModel):
...
class PracticeNoFollowUpRequiredCompletionResponse(PracticeDomainModel):
    status: Literal["completed"]
    reason: Literal["noFollowUpRequired"]


class PracticeAllAnsweredCompletionResponse(PracticeDomainModel):
    status: Literal["completed"]
...
class PracticeEndedEarlyFollowUpCompletionResponse(PracticeDomainModel):
...
class PracticeEvaluationResponse(PracticeDomainModel):
...
class PracticeReviewContentResponse(PracticeDomainModel):
...
class PracticeUnfinishedAttemptResponse(PracticeDomainModel):
    attempt_id: StandardUUID
    attempt_number: Annotated[int, Field(ge=1)]
    selection: PracticeSessionSelection
    question: PracticeQuestionResponse
...
class PracticeCompletedSessionResponse(PracticeDomainModel):
    status: Literal["completed"]
    session_id: StandardUUID
    language: InteractionLanguage
    version: Annotated[int, Field(ge=1)]
...
class CurrentPracticeSessionResponse(PracticeDomainModel):
