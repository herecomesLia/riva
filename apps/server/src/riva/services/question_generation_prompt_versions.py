...
# This is the exact weakness-aware prompt that was canonical before v3.  Keep
# it here so queued and replayed v2 runs never receive the v3 memory block.
QUESTION_GENERATION_V2_PROMPT = PromptDefinition(
    prompt_id="question-generator",
    version="2",
    output_schema_id="question-generation-v1",
    output_schema=QuestionGenerationOutput,
...
QUESTION_GENERATION_ACCEPTED_PROMPT_VERSIONS = frozenset(
    {
        ...
        QUESTION_GENERATION_V2_PROMPT.version,
...
def get_question_generation_prompt(
    ...
    if version == QUESTION_GENERATION_V2_PROMPT.version:
        return QUESTION_GENERATION_V2_PROMPT
