...
def install_interview_service(app, service, current_user) -> None:
    ...
    async def get_service() -> InterviewAPIService:
        return service

    app.dependency_overrides[require_current_user] = get_user
    app.dependency_overrides[get_interview_api_service] = get_service
...
def test_interview_requires_authentication(app) -> None:
    app.dependency_overrides[get_interview_api_service] = lambda: object()
