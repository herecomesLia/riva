...
from riva.api.dependencies import require_user_service
...
from riva.services.user import AuthResult, CurrentSession
    ...
    async def login(
        ...
        *,
        ...
        try:
            ...
            raise InvalidCredentialsError("invalid_credentials") from exc
