...
export function RoleCreationDialog({
  ...
  onManualCreate: (input: CreateRoleRequest) => Promise<void>
...
function TextImportPanel({
  ...
  return (
    <FieldGroup>
      <Field invalid={error}>
        <FieldLabel htmlFor="role-import-text">{t("roles.creation.text.label")}</FieldLabel>
...
function ImageImportPanel({
  ...
  return (
    <FieldGroup>
      <Field invalid={error}>
        <FieldLabel htmlFor="role-import-images">{t("roles.creation.image.label")}</FieldLabel>
        <FieldDescription>{t("roles.creation.image.description")}</FieldDescription>
        <FieldControl>
          <Input
            accept="image/png,image/jpeg,image/webp"
            aria-required="true"
            id="role-import-images"
            multiple
...
function UrlImportPanel({
  ...
  return (
    <FieldGroup>
      <Field invalid={error}>
        <FieldLabel htmlFor="role-import-url">{t("roles.creation.url.label")}</FieldLabel>
