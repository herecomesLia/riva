export const practice = {
  ...
  review: {
    ...
    actionsDescription:
      "This step exposes the actions only. Training state transitions will be implemented next.",
    retryCurrent: "Retry current question",
    nextQuestion: "Continue to next question",
    endSession: "End practice session",
  },
  completed: {
