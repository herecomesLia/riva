export const interview = {
  ...
  session: {
    ...
    candidateAnswer: {
      title: "Generating RIVA question analysis",
      description:
        "RIVA is analyzing your question against the role information and preparing training guidance.",
      failedTitle: "RIVA question analysis could not be generated",
      failedDescription:
        "Your question is saved, so you can retry the analysis without submitting it again.",
    },
    reviewGeneration: {
    ...
    candidate: {
      ...
      exchangesDescription:
        "Review RIVA's question-quality analysis, improvement suggestions, and recommended focus areas.",
      ...
      betterQuestion: "Suggested wording",
      ...
      noAnalysisDescription:
        "No usable analysis was generated for this question. You can continue with another question.",
    ...
    errors: {
      ...
      candidateAnswerTitle: "Unable to generate RIVA question analysis",
      candidateAnswerDescription: "Your question is preserved. Retry the analysis to continue.",
